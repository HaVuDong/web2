...
public class PayosRestGateway implements PayosGateway {
    ...
    /**
     * Gọi API của PayOS qua HTTP (sử dụng RestClient) để tạo link thanh toán.
     * Tự động thêm chữ ký (signature) vào body và các thông tin xác thực vào header.
     */
    @Override
    ...
    /**
     * Xử lý dữ liệu JSON trả về từ PayOS và chuyển đổi thành đối tượng Response.
     * Kiểm tra mã lỗi (code = "00" là thành công), nếu có lỗi sẽ ném ngoại lệ.
     */
    ...
    /**
     * Hàm hỗ trợ chuyển đổi một giá trị thành chuỗi String an toàn (xử lý trường hợp null).
     */
