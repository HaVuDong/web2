...
public class RoomController {
    ...
    /**
     * API: Lấy danh sách các phòng thuộc một tòa nhà cụ thể.
    ...
    /**
     * API: Tạo mới một phòng trong tòa nhà.
    ...
    /**
     * API: Lấy thông tin chi tiết một phòng theo ID.
    ...
    /**
     * API: Cập nhật thông tin phòng (tên phòng, diện tích, giá thuê, sức chứa...).
    ...
    /**
     * API: Xóa một phòng. Chỉ xóa được khi phòng chưa có hợp đồng/người thuê.
    ...
    /**
     * API: Cập nhật trạng thái phòng (ví dụ: chuyển sang trạng thái đang bảo trì).
